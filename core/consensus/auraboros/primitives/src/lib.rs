...
pub use digest::{BABE_VRF_PREFIX, AuraPreDigest, RawAuraborosPreDigest, RawBabePreDigest};
...
/// The `ConsensusEngineId` of AuraBoros.
pub const AURABOROS_ENGINE_ID: ConsensusEngineId = *b"ABRS";
